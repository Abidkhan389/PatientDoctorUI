...
export class Helpers {
    ...
    public static removeValidators(form: UntypedFormGroup, controlArr) {
    ...
    public static addValidators(form: UntypedFormGroup, controlArr) {
        for (var value of controlArr) {
    ...
    public static removeCtrlValidators(form: UntypedFormGroup, formCtrl) {
        form.controls[formCtrl].clearValidators();
        form.controls[formCtrl].updateValueAndValidity();

    }

    public static addCtrlValidators(form: UntypedFormGroup, formCtrl, valdation) {
