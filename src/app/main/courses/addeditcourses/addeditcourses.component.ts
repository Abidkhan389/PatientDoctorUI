...
export class AddeditcoursesComponent extends DropDownUtils implements OnInit {
  ...
  constructor(private fb: UntypedFormBuilder, protected lookupService: LookupService, protected router: Router, private dialogref: MatDialogRef<AddeditcoursesComponent>,
